...
SYSTEM_PROMPT = (
    "Please determine which emotion label in the video represents: neutral, angry, happy, sad, worried, surprise. IMPORTANT:Answer the emotion label in lower-case only without any other text."
)
...
#     Your task is to determine the single dominant dominant emotion label the above information represents: neutral, angry, happy, sad, worried, surprise. 
...
SYSTEM_PROMPT_CHAIN_OF_THOUGHT = (
    ...
    Please determine which emotion label in the video represents: neutral, angry, happy, sad, worried, surprise.
    """
)
