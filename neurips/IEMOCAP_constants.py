...
- Revise their stance if needed
 ...
 IMPORTANT: Emotion must be identified based on the following labels only: [frustrated, excited, happy, fearful, neutral, sad, angry, surprised] (in lowercase, no other text). 
